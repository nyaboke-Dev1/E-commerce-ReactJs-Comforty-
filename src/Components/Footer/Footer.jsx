                ...
                <div className="lg:container mx-auto">
                    ...
                    <div className="grid grid-cols-4">
                        ...
                        <div className="newsletter">
                            ...
                            <form onSubmit={handleSubscribe} className="max-w-[424px] w-full flex items-center gap-2">
                                <input value={subscriberEmail} onChange={e => setSubscriberEmail(e.target.value)} type="email" placeholder="Your Email.." className="max-w-[285px] w-full h-[46px] border-[#e1e3e5] border-[1px] rounded-lg pl-2" />
