        ...
        <div className="lg:container mx-auto p-[80px]">
            ...
            <div className="max-w-[648px] w-full min-h-[382px] p-[31px] mx-auto flex items-center justify-center flex-col rounded-lg border-[1px] border-[#9a9caa]">
                ...
                <form action="#" onSubmit={submitHandle} className="flex flex-col items-center w-full space-y-4">
                    <input value={name} onChange={e => setName(e.target.value)} type="text" placeholder="Your Name..." className="w-full h-[50px] bg-[#f0f2f3] rounded-lg pl-3.5" />
                ...
                <p className="text-base text-[#272343] font-normal font-inter flex items-center justify-center gap-2.5 mt-4">Don't have account <Link to={'/login'} className="text-[#007580]">Login</Link></p>
            </div>
